...
var _RegistrationMail = require('../app/jobs/RegistrationMail'); var _RegistrationMail2 = _interopRequireDefault(_RegistrationMail);
var _HelpOrderMail = require('../app/jobs/HelpOrderMail'); var _HelpOrderMail2 = _interopRequireDefault(_HelpOrderMail);
var _redis = require('../config/redis'); var _redis2 = _interopRequireDefault(_redis);

const jobs = [_RegistrationMail2.default, _HelpOrderMail2.default];
